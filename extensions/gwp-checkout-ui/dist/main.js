...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // extensions/gwp-checkout-ui/src/index.jsx
  ...
  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/hooks/app-metafields.mjs
  ...
  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/hooks/discounts.mjs
  ...
  function App() {
    const items = useCartLines(), metaData = useAppMetafields(), applyCartLinesChange = useApplyCartLinesChange(), applyDiscountCodeChange = useApplyDiscountCodeChange(), translate = useTranslate(), discountCodes = useDiscountCodes();
    const [exist, setExist] = (0, import_react20.useState)(false);
    const [qualify, setQualify] = (0, import_react20.useState)(false);
    const [conf, setConfig] = (0, import_react20.useState)({});
    ...
    class GWPHelper {
      constructor() {
        __publicField(this, "log", (m, k = "Debug") => {
          console.log(`PS-GWP[${k}]:`, m);
        });
        __publicField(this, "toCent", (value) => parseInt((parseFloat(value) * 100).toFixed(1)));
        __publicField(this, "toDollar", (value) => parseFloat((parseInt(value) * 0.01).toFixed(2)));
        __publicField(this, "checkQualify", (method, items2, pre_requirements, value) => {
          let fn = method === 1 ? "checkQuantity" : "checkThreshold";
          this[fn](items2, pre_requirements, value);
        });
        __publicField(this, "getHashString", (pid, vid, secret_number) => {
        ...
        __publicField(this, "showEmpty", () => {
          this.logStatus();
          return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, {});
        });
        __publicField(this, "checkThreshold", (items2, pre_requirements, value) => {
          let amount = 0;
          items2.forEach((item) => {
        ...
        __publicField(this, "checkQuantity", (items2, pre_requirements, value) => {
          let quantity = 0;
          items2.forEach((item) => {
            let pid = parseInt(item.merchandise.product.id.split("/").pop());
            if (pre_requirements.find((o) => o === pid)) {
        ...
        __publicField(this, "addItem", () => __async(this, null, function* () {
          setAdding(true);
          ...
          const code_result = yield applyDiscountCodeChange({
    ...
    (0, import_react20.useEffect)(() => {
      ...
      new Promise((resolve, reject) => {
        let configs = metaData.find((o) => {
          var _a;
          return ((_a = o == null ? void 0 : o.target) == null ? void 0 : _a.type) === "shop";
        });
        if (!configs)
          return reject("Shop Meta is empty!");
    ...
    (0, import_react20.useEffect)(() => {
      setLoading(true);
      if ((0, import_isEmpty.default)(conf) || (0, import_isEmpty.default)(items))
        return;
      if ((conf == null ? void 0 : conf.status) === true) {
        helper.checkQualify(conf.method, items, conf.pre_requirements, conf.value);
        if (!qualify) {
          const clearData = (items2, target, attr_key, code) => __async(this, null, function* () {
            let item = items2.find((item2) => {
              let pid = parseInt(item2.merchandise.product.id.split("/").pop());
              if (pid !== target.pid)
                return false;
              if (item2.cost.totalAmount === 0)
                return true;
              let attr = item2.attributes.find((attr2) => attr2.key === attr_key);
              if (!attr)
                return false;
              return true;
            });
            ...
            let result;
            if (found_code) {
              result = yield applyDiscountCodeChange({
            ...
            if (item && (conf.force_remove || item.cost.totalAmount === 0)) {
              result = yield applyCartLinesChange({
                type: "removeCartLine",
                id: item.id,
                quantity: item.quantity
              });
    ...
    if (qualify && !exist) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "loose", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { level: 3, children: translate("sub-title") }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { spacing: "loose", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          InlineLayout2,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { spacing: "none", children: conf.target.image ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Image2, { source: conf.target.image, loading: "lazy" }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SkeletonImage2, { aspectRatio: 1 }) }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { spacing: "none", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: conf.target.title }) }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { spacing: "none", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { kind: "primary", loading: adding, onPress: helper.addItem, children: translate("add") }) })
            ]
          }
        ) }),
        error && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { status: "critical", children: "There was an issue adding this product. Please try again." })
      ] });
    }
