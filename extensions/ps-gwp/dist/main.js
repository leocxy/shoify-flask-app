...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // extensions/ps-gwp/src/index.jsx
  ...
  function App() {
    const items = useCartLines(), metaData = useAppMetafields(), applyCartLinesChange = useApplyCartLinesChange(), translate = useTranslate();
    const [exists, setExists] = (0, import_react20.useState)(false);
    ...
    class GWPHelper {
      constructor() {
        ...
        __publicField(this, "checkGiftProduct", (items2, target, attr_key) => {
          let item = items2.find((item2) => {
            let pid = parseInt(item2.merchandise.product.id.split("/").pop());
            return pid === target.pid && item2.attributes.find((attr) => attr.key === attr_key);
          });
          if (!item)
            return;
          this.log("Found");
    ...
    (0, import_react20.useEffect)(() => {
      ...
      if ((0, import_isEmpty.default)(conf) || (0, import_isEmpty.default)(items))
        return;
      if ((conf == null ? void 0 : conf.enable) === true) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BlockStack2, {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BlockStack2, {
            spacing: "loose",
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(InlineLayout2, {
              spacing: "base",
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BlockStack2, {
                  spacing: "none",
                  children: conf.target.image ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image2, {
                    source: conf.target.image,
                    loading: "lazy"
                  }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SkeletonImage2, {
                    aspectRatio: 1
                  })
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BlockStack2, {
          ...
          error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Banner2, {
            status: "critical",
            children: "There was an issue adding this product. Please try again."
          })
        ]
      });
    }
