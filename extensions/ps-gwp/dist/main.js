...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  var GWPHelper = class {
    constructor(values, items, lineItemsChange) {
      ...
      this.items = items;
      this.enable = (values == null ? void 0 : values.enable) === void 0 ? false : values.enable;
      this.method = (values == null ? void 0 : values.method) === void 0 ? 1 : values.method;
      this.value = (values == null ? void 0 : values.value) === void 0 ? 999999 : values.value;
      this.target = values == null ? void 0 : values.target;
      this.pre_requirements = (values == null ? void 0 : values.pre_requirements) === void 0 ? [] : values.pre_requirements;
      this.secret_number = (values == null ? void 0 : values.secret_number) === void 0 ? 1 : values.secret_number;
      this.key = (values == null ? void 0 : values.attr_key) === void 0 ? "_gwp_hash_str" : values.attr_key;
    ...
    clearExtraFreeGift() {
      ...
      let item = this.items.find((item2) => {
        ...
        return pid === this.target.pid && item2.attributes.find((attr) => attr.key === this.key);
      });
      if (!item)
        return;
      this.log(`Found!`);
  ...
  function App() {
    let [loading, setLoading] = (0, import_react17.useState)(false);
    const items = useCartLines(), metaData = useAppMetafields(), lineItemsChange = useApplyCartLinesChange(), translate = useTranslate();
    let configs = metaData.find((o) => {
      var _a;
      return ((_a = o == null ? void 0 : o.target) == null ? void 0 : _a.type) === "shop";
    });
    if ((0, import_isEmpty.default)(items) || !configs)
    ...
    if (helper.qualified && !helper.existed) {
      let image = helper.target.image ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image2, {
        source: helper.target.image,
        loading: "lazy"
      }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SkeletonImage2, {
        blockSize: "fill"
      });
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(InlineLayout2, {
        columns: [100, "fill", "25%"],
        border: "base",
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(View2, {
            border: "none",
            padding: "base",
            children: [
